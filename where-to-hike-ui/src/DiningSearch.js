...
function DiningSearch(props)
{
    ...
    const deleteSearch = (e)=>
    {
       if (window.confirm("Do you wish do delete the search " + props.search.name))
       {
         ...
         //axios.delete('http://where-to-hike.perfect300rock.com/api/search/' + props.search.id)
         .then(rest =>{
    ...
    const loadSearchAvailability= () =>
    {
      ...
      //axios.get('http://where-to-hike.perfect300rock.com/api/availability/' + props.search.name)
      .then(resp => 
      {
