...
//              <label className="bannerLabel">Where to Hike Dining Availability Search</label>
//              </div>      	
//            </div>
//            <div className="container welcomeContent">
//                      The Where to Hike Dining Availability application continously searches for dining availability based on desired search
...
//    </Router>
    <div align="left"  className="App">
        ...
        <div className="container welcomeContent">
              The Where to Hike Dining Availability application continuously searches for dining availability based on desired search
